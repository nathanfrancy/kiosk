...
?>
			...
			<nav class="nav-admin">
				<div class="btn-group">
					<a type="button" class="btn btn-primary navigation" href="home.php?page=department">Department Manager</a>
					<a type="button" class="btn btn-primary navigation active" href="home.php?page=user">User Manager</a>
				</div>
			</nav>
		</div>
